...
def main():
    ...
    model_with_custom_head = nn.YOLOwithCustomHead(name_backbone, pretrained_weights_path)
    ...
    # Optimizer
    optimizer = torch.optim.SGD(util.set_params(model_with_custom_head, weight_decay),
